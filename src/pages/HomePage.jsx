...
const services = [
  {
    ...
    text: "Florida's sun and storms are brutal on exteriors. We protect and beautify your home with premium paints rated for Central Florida's climate.",
  ...
  },
  {
    ...
    text: 'Transform any room with precise, clean application. We protect your furniture, floor, and finishes — and leave your home spotless.',
    to: '/services/residential',
  },
  {
    icon: <BuildingIcon />,
...
const areas = ['Lakeland','Kathleen','Bartow','Winter Haven','Plant City','Mulberry','Lake Wales','Polk City'];
    ...
    <>
      ...
      <section className="hero" aria-label="Hero">
        ...
        <div
          ...
          style={{
            background: 'linear-gradient(160deg, #1B3A5C 0%, #2A5F8F 55%, #3378B0 100%)',
          }}
          aria-hidden="true"
        />
        {/* Diagonal accent */}
        ...
        <div className="hero__content container-site w-full py-20 lg:py-0">
          <div className="max-w-3xl fade-up">
            <p className="section-label text-brand-sky mb-6">
              Polk County's Trusted Painters
            </p>
            <h1 className="hero-title mb-6 text-balance">
              Expert Painting &amp;<br />Paver Sealing in<br />
              <span className="text-brand-sky">Lakeland, FL</span>
            </h1>
            <p className="hero-subtitle mb-10 max-w-xl">
              Over 15 years serving Central Florida homeowners and businesses. Licensed, insured, and obsessed with quality. We answer the phone — even after hours.
            </p>
            <div className="flex flex-wrap gap-4 items-center">
              <a href={PHONE_HREF} className="btn btn--phone btn--lg">
                📞 Call {PHONE}
              </a>
            ...
            {/* Trust signals */}
            <div className="flex flex-wrap gap-6 mt-10 text-white/75 text-sm font-semibold">
              {['Licensed & Insured','Free Estimates','After-Hours Support','100% Satisfaction'].map(t => (
                <span key={t} className="flex items-center gap-2">
                  <span className="text-brand-sky">✓</span>{t}
                </span>
              ))}
            </div>
          </div>
          ...
          <div className="split-layout">
            <div>
              ...
              <p className="text-brand-gray text-xl leading-relaxed mb-8">
                We're a small, owner-operated company — which means Josh personally oversees every project from estimate to final walkthrough. No subcontractors cutting corners.
              </p>
      ...
      <section className="section section--navy">
        <div className="container-site">
          <div className="text-center mb-12">
            <p className="section-label justify-center text-brand-light">Where We Work</p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {areas.map(area => (
              <Link
                key={area}
                to={`/service-areas/${area.toLowerCase().replace(' ','-')}`}
                className="card card--area card--flat bg-white/5 border-white/10 hover:bg-white/10 text-center p-6"
              >
                <div className="font-display font-bold text-white text-lg mb-1">{area}</div>
                <div className="text-brand-light text-xs uppercase tracking-wider">Polk County, FL</div>
                <div className="text-brand-sky mt-2 text-sm card__arrow">View Area →</div>
              </Link>
            ))}
          </div>
        </div>
