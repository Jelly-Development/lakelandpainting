...
const serviceData = {
  residential: {
    ...
    process: [
      { step: '01', title: 'Free Estimate', text: 'We visit your property, assess the scope, and provide a detailed written quote — no surprises.' },
      { step: '02', title: 'Prep & Protect', text: 'Power washing, sanding, caulking, patching, priming, and full protection of unpainted surfaces.' },
      { step: '03', title: 'Expert Application', text: 'Two or more coats of premium paint applied to manufacturer specifications for a lasting finish.' },
      { step: '04', title: 'Final Walkthrough', text: "We inspect every inch with you. You don't pay until you're 100% satisfied." },
    ],
  },
  ...
  commercial: {
    ...
    process: [
      { step: '01', title: 'Site Assessment', text: 'We evaluate the property, discuss scope and timeline, and deliver a detailed written proposal.' },
      { step: '02', title: 'Scheduling', text: 'We coordinate with your team to minimize disruption to business operations.' },
      { step: '03', title: 'Prep & Paint', text: 'Professional surface preparation and premium commercial coating application.' },
      { step: '04', title: 'Sign-Off', text: 'Final walkthrough with your property manager or owner. No payment until complete.' },
    ],
  },
  ...
  'paver-sealing': {
    ...
    process: [
      { step: '01', title: 'Free Estimate', text: 'We assess your pavers, identify problem areas, and provide an honest written quote.' },
      { step: '02', title: 'Power Washing', text: 'High-pressure wash removes all mold, dirt, stains, and loose material from the surface.' },
      { step: '03', title: 'Sand & Prep', text: 'Re-joint with polymeric sand where needed and allow surface to fully dry before sealing.' },
      { step: '04', title: 'Seal & Protect', text: 'Professional-grade sealer applied evenly for lasting protection and enhanced appearance.' },
    ],
  },
};
  ...
  return (
    <>
      ...
      {data.services.map((svc, idx) => (
        ...
        >
          <div className="container-site">
            <div className={`split-layout ${idx % 2 === 1 ? 'split-layout--reversed' : ''}`}>
              {/* Text */}
              <div>
              ...
              >
                <div className="text-white/30 text-center">
                  ...
                  <p className="text-sm font-semibold uppercase tracking-widest mt-3 text-white/40">Photo Gallery</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {data.process.map(({ step, title, text }) => (
              <div key={step} className="bg-white/5 border border-white/10 rounded-xl p-6 hover:bg-white/10 transition-colors">
                <div className="font-display text-4xl font-bold text-brand-sky/40 mb-3">{step}</div>
      ...
      <section className="section section--offwhite">
        <div className="container-site">
          <h2 className="section-title section-title--center mb-10">Explore Our Other Services</h2>
            ...
            {Object.values(serviceData)
              ...
              .map(s => (
                ...
                >
                  ...
                  <div className="text-brand-sky text-sm font-semibold">Learn More →</div>
                </Link>
              ))}
          </div>
        </div>
